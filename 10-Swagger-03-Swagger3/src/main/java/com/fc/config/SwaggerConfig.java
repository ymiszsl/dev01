...
// 页面上会显示需要传递一个Authorization参数作为请求头
    public List<SecurityScheme> token(){
    ...
    private  List<SecurityContext> securityContexts(){
        ...
        AuthorizationScope scope = new AuthorizationScope("global","访问全局环境");
        AuthorizationScope[] scope1 = new AuthorizationScope[1];
        scope1[0] = scope;
references.add(new SecurityReference("Authorization",scope1));
